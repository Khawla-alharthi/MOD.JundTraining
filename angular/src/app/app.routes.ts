...
import { TRAINING_ROUTES } from '@m-oD/training';
import { VEG_ROUTES } from './vegs/veg/veg-routes';
...
export const APP_ROUTES: Routes = [
  ...
  {
    path: 'training',
    loadChildren: () => import('@m-oD/training').then(m => m.TRAINING_ROUTES),
  },
  { path: 'vegs', children: VEG_ROUTES },
];
