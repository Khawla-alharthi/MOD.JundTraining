...
```bash
ng build training --watch
```

## Code scaffolding

Run `ng generate component component-name --project training` to generate a new component in the library.
...
```bash
npm install @m-oD/training
```

2. Import the module in your application:
```typescript
import { TrainingModule } from '@m-oD/training';
